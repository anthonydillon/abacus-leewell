...
<body class="<?php echo $post_slug; ?>">
    <header class="wrapper inner-wrapper">
        ...
        <nav role="navigation" class="nav-primary">
            <p class="right">
                <a href="http://www.abacusleewellonline.co.uk" target="_blank" style="margin-right: 10px;">Shop</a>
                <a href="<?php echo site_url(); ?>/book-a-repair" <?php echo ($post_slug == 'book-a-repair' ? 'class="is-active"': '')?>>Book a Repair</a>
            </p>
